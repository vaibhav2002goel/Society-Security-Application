...
<body>
    ...
    <form action="signIn" method="POST" class="form login">
    ...
    <p class="text--center"><b style="color:white;">Not a member?</b> <a style="color:black;" href="./signUp.jsp">Sign up now</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
