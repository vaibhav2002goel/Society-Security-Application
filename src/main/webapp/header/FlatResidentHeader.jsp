		    ...
		    <div class="collapse navbar-collapse" id="navbarText">
			    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
			      ...
			      <li class="nav-item" style="margin:0 46%;">
			        <a class="nav-link active" aria-current="page" href="FlatResident.jsp" style="font-size:20px;">Home</a>
			      </li>			  
			      
			      <li class="nav-item" style="margin:0 46%;">
			        <a class="nav-link active" aria-current="page" href="FlatResidentEntryLog.jsp" style="font-size:20px;">Entry Logs</a>
			      </li>
			      
			      <li class="nav-item" style="margin:0 46%;">
			        <a class="nav-link active" aria-current="page" href="FlatResidentMaintainenceCharge.jsp" style="font-size:20px;">Maintainence Charge</a>
			      </li>
