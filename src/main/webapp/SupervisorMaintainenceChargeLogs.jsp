...
<title>Maintaience Charge Logs</title>
	...
	<div class="bg">
	    ...
	    <%
			...
			try(Connection con = DriverManager.getConnection(url,user,password)) {
					...
					String query1 = "select * from maintainenceCharge where supervisorUsername=? ;";
		...
		%>	
					    <tr>
					      ...
					      <td>
					      	<form style="margin:0 60px;" action="maintainenceChargeStatus?flatNumber=<%= rs1.getInt("flatNumber") %>&buildingNumber=<%= rs1.getInt("buildingNumber") %>" method="post">						   
